    ...
    Private Sub GunaButton1_Click(sender As Object, e As EventArgs) Handles GunaButton1.Click
        Try
            If Me.ValidateChildren = True And txtUser.Text <> "" And txtpass.Text <> "" Then
                Using conexion1 As New SqlConnection(conexion2020transac)
                    conexion1.Open()
                    ...
                    Dim r As String = "select Login, Password from Usuarios where Login= " & "'" & txtUser.Text & "'"
                    comando.CommandText = r
                    lector = comando.ExecuteReader()
                    lector.Read()
                    If txtUser.Text = lector(0) And txtpass.Text = lector(1) Then
