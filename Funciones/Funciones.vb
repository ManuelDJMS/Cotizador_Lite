...
Module Funciones
    ...
    Public empresa As Integer = 0 'VARIABLE PARA BUSCAR EMPRESA FRMCOTIZACIONPORARTICULO
    ...
    Public anual As Integer
    Public cot As Integer = 0
    Public fol As Integer = 0
